...
- **scaffold-mcp:** add cli parity for mcp tools ([e461e89](https://github.com/AgiFlow/aicode-toolkit/commit/e461e89))
...
- Updated @agiflowai/architect-mcp to 1.2.0
- Updated @agiflowai/hooks-adapter to 0.1.1
